...
async function RootLayout({ children }) {
    // ดึงรายการหน้าหลักจากฐานข้อมูลมาทำลิงก์ดรอปดาว์นอัตโนมัติ
    let pages = [];
    try {
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].query('SELECT title, slug_path FROM pages WHERE parent_id IS NULL');
        pages = rows;
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1vsdl6h._.js.map